...
function Info() {
    return (
        <div className="main">
            ...
            <h2>PREGI</h2>
            <ul>
                <li className='row'>La moto è stata completamente smontata, pulita e rimontata con cura, mantenendo tutti i pezzi originali. L'unica modifica riguarda l'albero motore rinforzato, sostituito in seguito a una precedente elaborazione.</li>
